...
CREATE TABLE `tab_pagamento` (
  ...
  KEY `fk_tab_Pagamento_tab_Pedido1_idx` (`codPedido`),
  CONSTRAINT `fk_tab_Pagamento_tab_Pedido1` FOREIGN KEY (`codPedido`) REFERENCES `tab_pedido` (`idPedido`) ON DELETE NO ACTION ON UPDATE NO ACTION
