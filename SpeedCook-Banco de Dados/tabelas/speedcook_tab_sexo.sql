...
--
-- Dumping data for table `tab_sexo`
--

LOCK TABLES `tab_sexo` WRITE;
/*!40000 ALTER TABLE `tab_sexo` DISABLE KEYS */;
INSERT INTO `tab_sexo` VALUES (1,'Masculino','M'),(2,'Feminino','F');
/*!40000 ALTER TABLE `tab_sexo` ENABLE KEYS */;
UNLOCK TABLES;
